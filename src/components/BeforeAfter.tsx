            ...
            <div className="container-custom">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="order-2 lg:order-1 flex flex-col gap-6">
                        <ScrollReveal delay={0.2} className="relative aspect-[826/368] w-full rounded-[24px] md:rounded-[32px] overflow-hidden shadow-2xl bg-neutral-100 group">
                        ...
                        <ScrollReveal delay={0.2}>
                            <div className="flex items-center gap-4 py-6 border-t border-neutral-100 mt-4">
                                ...
                                <p className="text-black font-bold font-grotesk text-sm uppercase tracking-wider">
                                    Resultados Reais, Ética Profissional
                                </p>
                            </div>
                        </ScrollReveal>
                    </div>
                    ...
                    <div className="lg:hidden order-3 px-4">
                        <ScrollReveal delay={0.4}>
                            <p className="text-neutral-500 text-sm leading-relaxed mb-8">
                                Transformações reais feitas na nossa clínica. Casos realizados por nossa equipe com autorização dos pacientes.
                            </p>
                        </ScrollReveal>
                    </div>
                </div>
