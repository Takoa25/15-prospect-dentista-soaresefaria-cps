...
const images = {
    ...
    beforeAfter: [ // 826x368px (Horizontal)
        ...
        "/images/before_after5.webp",
        "/images/before_after6.webp",
        "/images/before_after7.webp",
        "/images/before_after8.webp",
    ],
    about: {
...
export const content: ContentConfig = {
    ...
    infos: {
        ...
        email: "contato@soaresfaria.com.br",
        address: "Av. Arymana, 1431, Sobreloja - Parque Dom Pedro II, Campinas/SP",
        miniAddress: "Av. Arymana, 1431 - Pq Dom Pedro II",
        mapsLink: "https://maps.app.goo.gl/W53v437oJFZ4VvPbA",
        mapsEmbed: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3673.2031647042886!2d-47.14767957132917!3d-22.97955546025824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94c8b74040f5494f%3A0xe6c038c2051aebf8!2sSoares%20%26%20Faria%20Odontologia!5e0!3m2!1spt-BR!2sbr!4v1766535168276!5m2!1spt-BR!2sbr",
    ...
    hero: {
        ...
        bottomStats: [
            ...
            { value: "Desde 2020", label: "Transformando Vidas" },
        ],
        ctaPrimary: {
            text: "Agendar Agora",
            link: "#contact",
    ...
    beforeAfter: {
        ...
        description: "Transformações reais feitas na Soares & Faria Odontologia. Todos os casos foram realizados por nossa equipe com autorização dos pacientes para publicação.",
    ...
    about: {
        ...
        description: "Na Soares & Faria Odontologia, nosso objetivo é proporcionar a você não apenas um sorriso bonito, mas saúde e qualidade de vida. Nossa equipe é especializada em transformar vidas através da odontologia moderna.",
        features: [
            {
    ...
    testimonials: {
        ...
        headlineHighlight: "",
        subtitle: "Veja o que nossos pacientes dizem sobre sua experiência na Soares Faria Odontologia.",
        items: [
            {
                id: 1,
                name: "Mariano R.",
            ...
            },
            {
                ...
                name: "João P.",
                role: "Advogado",
                content: "O Dr. Carlos resolveu meu problema de implantes que outros dentistas disseram ser impossível.",
                rating: 5,
            ...
            },
            {
                ...
                name: "Juliana K.",
                role: "Contadora",
                content: "Atendimento impecável desde a recepção até a consulta com a Dra. Maria. Pontualidade e profissionalismo nota 10.",
                rating: 5,
    ...
    location: {
        ...
        description: "",
        hours: [
            { label: "Seg - Sex", time: "08:30 - 18:00" },
            { label: "Sáb", time: "08:30 - 12:00" },
    ...
    footer: {
        ...
        socialLinks: {
            instagram: "https://instagram.com/soares_odontologia_campinas",
            facebook: "https://facebook.com/soares_odontologia_campinas",
            youtube: "https://youtube.com/soares_odontologia_campinas",
        },
        quickLinks: [
